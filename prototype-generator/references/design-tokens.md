...
| GNB (h44, px24, 703:71644) | 로고 18 Bold white · 메뉴 16 Regular gray300, px20 py4 r4, **간격 10** · 활성 16 **Bold** gray100 + bg gray700 · 설정 14 gray100, border gray500 r999 px12 py6 · [QR 발주서 작성] 15 Regular gray900, white bg r6 px12 py4, 아이콘 16 |
...
| QR 그룹 카드 | **그림자 없음** — white bg + **border gray200**, r12, **p24**(상하 20→24 변경) · '그룹 ID' 라벨 12 Medium gray400 · ID **18 Bold** gray900 · 필드 라벨 14 Regular gray400(폭 64) · 값 15 Regular **gray700**(수량 숫자도 15 Regular — '장'과 동일 웨이트) · 행 간격 6, ID↔필드 20, 필드↔제품 24 · 마케팅 칩 bg **gray50 r999** 13 Medium gray500 |
