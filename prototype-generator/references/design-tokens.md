...
| 필터바 | '전체' 15 Regular gray500 + 카운트 15 **Bold gray900**, 간격 6(스크린샷 대조로 확정 — 코드 덤프의 상속 색만 믿지 말 것) · 셀렉트 h36 r6 border gray200, 14 Regular **gray600**, 화살표 16 · 고정 폭: 최신순 104 / QR 전체 142 / 기간 240(날짜 13px) |
