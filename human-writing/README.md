...
| 모드 | 언제 | 무엇을 |
| --- | --- | --- |
| 작성 | 이슈·PR·기획서·정책·답변 등 모든 한국어 글을 쓸 때 | 뜻이 다 보이는 문장(60자는 참고치), 번역투·상투 표현 금지, 한자어를 비유·관용구로 바꾸지 않기, 비교 항목은 표, 막연한 말은 숫자·사례로 |
...
- `references/ai-patterns-ko.md` — 한국어 AI 글 패턴 10분류와 전/후 예시, 윤문이 오히려 만드는 AI 티(억지 동의어·비유 대체) 사례
