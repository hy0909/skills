...
- When the feature specification is being written for the current user, always write `Codex, hy0909` in every change-history `작성자` cell, including the initial creation row and later revisions.
