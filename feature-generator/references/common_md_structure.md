...
- When writing a feature specification for the current user, always use `Codex, hy0909` in the `작성자` column for the initial creation row and every revision row.
